            ...
            child: ListView(
              ...
              children: <Widget>[
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.of(context)
                          .pushReplacementNamed(AppRoutes.name);
                    },
                  ),
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context)
                        .pushReplacementNamed(AppRoutes.rowPhotos);
                  },
                ),
                ListTile(
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context)
                        .pushReplacementNamed(AppRoutes.challenge);
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context)
                        .pushReplacementNamed(AppRoutes.disposition);
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context)
                        .pushReplacementNamed(AppRoutes.counter);
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context)
                        .pushReplacementNamed(AppRoutes.instagram);
                  },
                ),
                ListTile(
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context)
                        .pushReplacementNamed(AppRoutes.sieteYMedia);
                  },
                ),
                ListTile(
